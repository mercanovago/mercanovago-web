...
export default function AdminPage() {
  const modules = [
    ...
    {
      title: "Seguridad",
      description: "Cambiar contraseña y cerrar sesión.",
      href: "/admin/security",
      icon: "🔐",
        ...
        <section className="mx-auto max-w-7xl px-8 py-14">
          <div className="mb-12">
            ...
            <p className="mt-4 max-w-3xl text-lg text-zinc-500">
              Bienvenido al centro de control de MercaNova GO. Desde aquí
              podrás administrar toda la operación de la plataforma.
            </p>
          </div>
            ...
            {modules.map((module) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <h2 className="mt-6 text-3xl font-black">{module.title}</h2>

                  <p className="mt-3 text-zinc-500">{module.description}</p>
          ...
          <div className="mt-14 rounded-3xl bg-white p-8 shadow-lg">
            <div className="flex items-center justify-between">
              <h3 className="text-2xl font-black">Estado del sistema</h3>
